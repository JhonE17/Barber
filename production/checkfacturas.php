...
<?php
        ...
        $sql ="SELECT * FROM ereservas where id_reservas =".$id;
                
				$re = mysqli_query($con,$sql);
				while($row=mysqli_fetch_array($re))
				{
          $idR = $row['id_ereservas'];
					$nombreR = $row['fullname'];
					$emailR = $row['email'];
					$barberoR = $row['barbero'];
					$fechaR = $row['fecha'];
					$nreservasR = $row['nreservas'];
					$tiposervicioR = $row['tipo_servicio'];
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>CONFIRMACIÓN DE RESERVA</h3><br>
              </div>
